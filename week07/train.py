...
BERT_PATH =Path(r"D:\Users\project\lstm语言模型生成文本\bert-base-chinese")
DATA_DIR = ROOT / "data" / "cluener"
CKPT_DIR = Path(r"D:\Users\project\outputs\checkpoints")
LOG_DIR =  Path(r"D:\Users\project\outputs\logs")
...
def main():
    ...
    # 标签体系
    labels, label2id, id2label = build_label_schema(dataset_type=args.dataset)
...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="peoples_daily", choices=["cluener", "peoples_daily"],
                        help="数据集类型：cluener 或 peoples_daily")
